#ifndef READERS_WRITERS_COLORSQMATRIXOBSERVABLE_H
#define READERS_WRITERS_COLORSQMATRIXOBSERVABLE_H
...
namespace model {
    class ColorSqMatrixObservable : public Observable {
    ...
    public:
        ColorSqMatrixObservable(unsigned square_size) {
            size = square_size;
...
#endif //READERS_WRITERS_COLORSQMATRIXOBSERVABLE_H
